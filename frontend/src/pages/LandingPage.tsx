    ...
    return (
        <div className="overflow-x-hidden">
                <div className="relative md:h-screen overflow-hidden " id="#">
                    ...
                    <div className="flex justify-center h-full ">
                        <div className=" text-center relative ">
                                <div className="text-8xl font-bold text-neutral-700 dark:text-white mt-44 ">
                                    Record Studio-Quality <br />Podcasts and  videos<br /> from <span className="text-blue-500 dark:text-blue-400">AnyWhere</span> 
                                </div>
                                ...
                                <div className="mt-4 text-3xl text-neutral-800 dark:text-white font-bold">
                                    Trusted By
                                </div>
                                ...
                                <div className="flex gap-4 mt-12  items-center justify-center">
                                    <Button size={"lg"} className="bg-blue-400 cursor-pointer" onClick={() => navigate("/signup")}>Start Recording for free</Button>
                                    <Button size={"lg"} variant={"secondary"} onClick={() => navigate("/signup")} className="cursor-pointer">Request a demo</Button>
                                </div>
                        </div>
            ...
            <div className=" max-w-screen py-16 " id="pricing">
                <h1 className="text-6xl text-center">Find the <span className="text-blue-600 dark:text-blue-500 font-bold">"Perfect"</span> Plan <br /> for your needs</h1>
                <div className="text-center text-neutral-900 dark:text-neutral-500 pt-2 py-12 text-lg">Whether you're just starting out or running a large team, we've got you covered.</div>
                <PricingSection />
            </div>


            <div className="w-full relative mt-8 py-8  lg:h-full bg-neutral-200 dark:bg-neutral-900" id="Testimonials">
                ...
                <div className="w-full mt-8 dark:bg-black">
                    <Footer />
                </div>
            </div>
